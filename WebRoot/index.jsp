	...
	<div id="aa" class="easyui-accordion" style="width:200px;height:480px;">   
		<div title="班级信息管理" data-options="iconCls:'icon-reload'" style="overflow:auto;padding:10px;">   
			 <ul id="tt" class="easyui-tree" >   
				...
				<li>   
					<span><a url="page/classes/albumList.jsp">班级相册</a></span>   
				</li>   
				<li>   
					<span><a url="page/classes/course_classList.jsp">班级课表</a></span>   
				</li> 
				<li>   
					<span><a url="page/classes/homeworkList.jsp">宝宝作业</a></span>   
				</li>
			</ul>  
		...
		<div title="视频管理" data-options="iconCls:'icon-reload'">   
			<ul id="tt" class="easyui-tree" >   
				<li >   
					<span><a url="page/video/publicList.jsp">公共视频</a></span>  
				</li> 
				<li >   
					<span><a url="page/video/privateList.jsp">班级视频</a></span>  
				</li>
			</ul>     
		</div> 
