...
<div style="width:200px;margin-top: 200px;margin-left: 400px;">
	<table align="center">
		<tr height="50" align="left">
			<td>上传到&nbsp;&nbsp;<select name="" >
					<option value="" selected>猫和老鼠</option>
				</select>
			</td>
		</tr>
		<tr align="left">
			<td><input type="file" value="选择动漫" ></td>
		</tr>
		<tr>
		<td height="40">
		<input type="button" onclick="ensure()" value="确定" style="width:80px;">&nbsp;&nbsp;
		<input type="button" onclick="javascript:location.href='cartoonList.jsp'" value="返回" style="width:80px;">
		</td>
    </tr>
	</table>
</div>
