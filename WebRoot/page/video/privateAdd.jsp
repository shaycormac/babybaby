...
<form name="frmAction"  method="post" action="" >
	<table width="60%" align="center">
			...
			<tr>
				...
				<td><input type="text" name="privateAddress" title="default" value="地点" style="width:420px;"></td>
			</tr>
			<tr>
			...
			<tr bgcolor="#E4E4E4">
				<td colspan="2" height="40" align="right" style="text-indent: 1em;">
					...
					<input type="button" name="test" value="返回" onclick="javascript:location.href='privateList.jsp'" style="width:80px;"/>
				</td>
			</tr>
	</table>
</form>
