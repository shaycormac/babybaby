...
function selectAll(){
	...
	var chk=document.getElementsByName("chkpublic");
...
<table width="95%" border="0" cellpadding="3" cellspacing="1" align="center" id="chkoperation"
		style="display:none;">
			<tr>
				...
				<input type="button" onclick="javascript:location.href='publicList.jsp'" value="返回" style="width: 80px;">
				</td>
			</tr>
		</table>
	<table >
		...
		<tr>
			<td>
				<div id="photo" style="width:140px;height:200px;margin-left:30px;float: left;">
					...
					background-image: url(/babyplan/img/video/24.jpg);background-size:cover;">
						<input type="checkbox" name="chkpublic" style="display:none" id="chk">
					</div>
					...
					<div name="edit" style="width:140px;float:left; text-align:right;margin-top: 10px;"> 
						<a href="/babyplan/page/video/publicEdit.jsp">编辑</a>
					</div>
				</div>
			</td>
		</tr>
