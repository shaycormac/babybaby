...
<form name="frmAction"  method="post" action="" >
	<table width="60%" align="center">
			...
			<tr>
				...
				<td><input type="text" name="albumName" title="default" value="六一儿童节" style="width:420px;"></td>
			</tr>
			<tr>
				<td width="150" align="right" >相册描述：</td>
				<td><textarea name="albumDescribe" cols="50" title="default" rows="5">描述</textarea></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
			...
			<tr bgcolor="#E4E4E4">
				<td colspan="2" height="40" align="right" style="text-indent: 1em;">
					...
					<input type="button" name="test" value="返回" onclick="javascript:location.href='photoList.jsp'" style="width:80px;"/>
				</td>
			</tr>
	</table>
</form>
