...
<table width="95%" border="0" cellpadding="3" cellspacing="1" align="center" id="chkoperation"
		style="display:none;">
			<tr>
				...
				<input type="button" onclick="javascript:location.href='photoList.jsp'" value="返回" style="width: 80px;">
				</td>
			</tr>
		</table>
	<table >
			...
			<td height="80" style="padding:20px;">
				...
				position: absolute;left:310px;top:65px;">
					<ul style="list-style: none;">
						<li style="line-height:25px;"><p><a href="/babyplan/page/classes/albumEdit.jsp">修改相册</a></p></li>
		...
		<tr>
			<td>
				<div id="photo" style="width:140px;height:170px;margin:20px;float: left;">
					...
					background-image: url(/babyplan/img/album/8.jpg);background-size:cover;">
						<input type="checkbox" name="chkphoto" style="display:none" id="chk">
					</div>
